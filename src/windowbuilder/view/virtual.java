...
public class virtual  extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_3Layout.setHorizontalGroup(
        	btn_3Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(btn_3Layout.createSequentialGroup()
        			.addComponent(jLabel10, GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        ...
        jLabel7.setIcon(new ImageIcon(virtual.class.getResource("/swing/images/icons8_Search_18px.png"))); // NOI18N
        ...
        jLabel12.setFont(new Font("Segoe UI", Font.PLAIN, 30)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("U: "+Log_in.ustr);
        jPanel4.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, -1, 30));

        jLabel6.setFont(new Font("Segoe UI", Font.PLAIN, 40)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");//设置日期格式
        jLabel6.setText(df.format(new Date()));
        ...
        lblNewLabel.setFont(new Font("宋体", Font.PLAIN, 70));
    ...
    private void btn_1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_1MousePressed
        ...
        getContentPane().add(ph, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 50, 650, 540));
        getContentPane().remove(pm);
    ...
    private void btn_2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_2MouseReleased
        ...
        getContentPane().add(pd, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 50, 650, 540));
        getContentPane().remove(ph);
        getContentPane().remove(pm);
        //pm.setVisible(false);
        //ph.setVisible(false);
